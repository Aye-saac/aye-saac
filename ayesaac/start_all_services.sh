...
python3 -u ./main.py services.position_detection.main > ./services_log/7_position_detection.txt &
python3 -u ./main.py services.natural_language_generator.main > ./services_log/8_natural_language_generator.txt &
python3 -u ./main.py services.text_to_speech.main > ./services_log/9_text_to_speech.txt &
